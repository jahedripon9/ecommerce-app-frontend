...
const Product = () => {
    ...
    const [productData, setProductData] = useState(null); // Initialize as null instead of false
    const [image, setImage] = useState('');
    const [size, setSize] = useState('')


    const fetchProductData = async () => { // Corrected arrow function syntax
                    ...
                    <div className="flex sm:flex-col overflow-x-auto sm:overflow-y-scroll justify-between sm:justify-normal sm:w-[18.7%] w-full">
                        {
                            productData.image.map((item, index) => (
                                <img
                                    ...
                                    alt=""
                                    onClick={() => setImage(item)} // Corrected onClick handler
                                />
                            ))
                        }
                    </div>
